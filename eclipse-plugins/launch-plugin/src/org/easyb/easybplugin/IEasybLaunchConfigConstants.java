...
public interface IEasybLaunchConfigConstants {
	public static final String LAUNCH_ATTR_PACKAGE_FOLDER = "EASYB_PACKAGE_FOLDER";
	...
	public static final String EASYB_RUNNER_LIB_NAME = "easyblib";
	public static final String STORY_FILE_EXTENSION = "story";
}
