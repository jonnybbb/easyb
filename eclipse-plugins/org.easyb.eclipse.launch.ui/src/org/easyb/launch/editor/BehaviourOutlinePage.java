...
import org.easyb.launch.editor.partitionmodel.Behaviour;
import org.easyb.launch.editor.partitionmodel.IModelElement;
import org.easyb.launch.editor.partitionmodel.PartitionModelException;
	...
	private class OutlineContentProvider implements ITreeContentProvider{
		...
		public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
			...
			try {
				...
				EasybLaunchActivator.Log("Unable to update behaviour model for outline view",e);
			}
		}
	}
